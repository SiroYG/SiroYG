...
public interface MemoInterface {
	 ...
	 * 
	 * @param UserAccount
	 * @return UserAccount 배열에 등록된 객체들 중 파라메터로 전달된 아이디,비밀번호 와 일치되는 UserAccount 객체,
	 *         검색 결과가 없을 시 null을 반환한다.
	 */
	 ...
	 * 
	 * @param UserAccount
	 * @return 주어진 아이디와 비밀번호가 일치되는 UserAccount 객체의 삭제 결과, UserAccount 배열에 등록된 객체들 중
	 *         파라메터로 전달된 아이디와 비밀번호가 일치되는 UserAccount 객체가 발견되어 삭제를 성공하면 true를 그렇지 않으면
	 *         false를 반환
	 */
